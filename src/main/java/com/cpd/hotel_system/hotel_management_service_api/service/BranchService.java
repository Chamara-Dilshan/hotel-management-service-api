...
public interface BranchService {
    ...
    public BranchPaginateResponseDto findAll(int page, int size, String searchTexxt);
    public BranchPaginateResponseDto findAllByHotelId(int page, int size, String hotelId ,String searchTexxt);
